...
/* Timer0 clock constants definitions */
#define TIMER0_PRESCALER										(64)							// prescaler value
#define TIMER0_CLK												(F_CPU/TIMER0_PRESCALER)			// Timer0 clock
#define TIMER0_TICK_PERIOD										(1.0/TIMER0_CLK)					// Timer0 tick period

/* Timer0 clock constants definitions */
#define TIMER1_PRESCALER										(1)							// prescaler value
#define TIMER1_CLK												(F_CPU/TIMER1_PRESCALER)			// Timer0 clock
#define TIMER1_TICK_PERIOD										(1.0/TIMER1_CLK)					// Timer0 tick period
