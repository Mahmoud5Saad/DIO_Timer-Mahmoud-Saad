...
void Led_On(En_LedNumber_t led_id)
{
	...
	{
		case LED_0:
		gpioPinWrite(LED_0_GPIO, LED_0_BIT, LED_ON_LEVEL);
		break;
		case LED_1:
		gpioPinWrite(LED_1_GPIO, LED_1_BIT, LED_ON_LEVEL);
		break;
		case LED_2:
		gpioPinWrite(LED_2_GPIO, LED_2_BIT, LED_ON_LEVEL);
		break;
		case LED_3:
		gpioPinWrite(LED_3_GPIO, LED_3_BIT, LED_ON_LEVEL);
		break;
		default:
		break;
	}
...
void Led_Off(En_LedNumber_t led_id)
{
	...
	{
		case LED_0:
		gpioPinWrite(LED_0_GPIO, LED_0_BIT, LED_OFF_LEVEL);
		break;
		case LED_1:
		gpioPinWrite(LED_1_GPIO, LED_1_BIT, LED_OFF_LEVEL);
		break;
		case LED_2:
		gpioPinWrite(LED_2_GPIO, LED_2_BIT, LED_OFF_LEVEL);
		break;
		case LED_3:
		gpioPinWrite(LED_3_GPIO, LED_3_BIT, LED_OFF_LEVEL);
		break;
		default:
		break;
	}
