 ...
 *
 */
extern ERR_STATUS ADC_Init(str_ADC_cfg_t* str_ADC_cfg);
 ...
 **/
extern ERR_STATUS ADC_Enable(void);
/**
 * Input:
 * Output:
 * In/Out:
 ...
 **/
extern ERR_STATUS ADC_Start_Polling(uint8 u8_ADC_Ch, uint16 *ADC_Read);
/**
 * Input:
 * Output:
 * In/Out:
 ...
 * and uses module isr
 **/
extern ERR_STATUS ADC_Start_Interrupt(uint8 u8_ADC_Ch);
 ...
 **/
extern ERR_STATUS ADC_Read(uint16* ADC_Read);
...
extern ERR_STATUS ADC_Set_AutoTrig(uint8 u8_ADC_Ch, uint8 u8_AutoTrigSource);
...
extern ERR_STATUS ADC_Stop_AutoTrig(void);
 ...
 *
 */
extern ERR_STATUS ADC_Stop(void);
 ...
 **/
extern ERR_STATUS ADC_Disable(void);
